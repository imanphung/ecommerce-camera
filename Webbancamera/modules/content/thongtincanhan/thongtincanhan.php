...
<form action="modules/content/thongtincanhan/xulythongtincanhan.php" method="POST" name="info-user" autocomplete="off" onsubmit="return validate_info_user(this)" enctype="multipart/form-data">
