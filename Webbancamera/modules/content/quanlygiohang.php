...
$count=count($_SESSION['giohang']);
    ...
    if(isset($_GET['themsoluong'])){
        ...
        for($i=0;$i<$count;$i++){
            if($_SESSION['giohang'][$i]["idsp"]==$id){
                if( $_SESSION['giohang'][$i]["soluong"]< $dong['soluongsp']){
...
<form action="modules/content/xuly.php" method="POST" name="cart" enctype="multipart/form-data">
    <div class="cart-wrap">
                <div class="cart-title">
                    ...
                    <div class="product-total">(<?php echo count($_SESSION['giohang']);?> loại sản phẩm)</div>
                    <div class="shipping">
                        ...
                        <div class="cart-row-inner">
                            ...
                            <div class="field-qty-col">
                                ...
                                <div class="field-status-col">
                                    <span>Còn <?php echo $dong['soluongsp']?> sản phẩm</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <ul>
                    <li>
                        <div class="oder-info-left">
                            <p>Tạm tính(<span><?php echo count($_SESSION['giohang']);?> loại sản phẩm</span>)</p></div>
